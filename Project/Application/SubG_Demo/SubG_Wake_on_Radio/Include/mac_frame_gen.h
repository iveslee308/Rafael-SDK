...
void Rfb_MacFrameGen_example(MacBuffer_t *pbuf, uint8_t *InitialCwAckRequest,
                             uint8_t Dsn, uint8_t MacDataLength,
                             uint16_t src_panid, uint16_t src_short_addr,
                             uint16_t dst_panid, uint16_t dst_short_addr,
                             uint16_t *data);
#endif
#endif
